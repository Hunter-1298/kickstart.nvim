...
-- mode == n, command = <space>q, calls function vim.diagostic.setlist
-- Diagnostic keymaps
...
require('lazy').setup({
  ...
  -- sets lualine for the bottom scrolling bar
  {
    ...
    config = function()
      require('lualine').setup {
        options = {
          theme = 'auto', -- Automatically set theme based on colorscheme
  ...
  -- cokeline adds buffers to the top of the terminal
  {
    'romgrk/barbar.nvim',
    dependencies = {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '/', builtin.current_buffer_fuzzy_find, { desc = 'Fuzzy search buffer' })
